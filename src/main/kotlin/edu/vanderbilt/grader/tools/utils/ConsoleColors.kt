...
//    fun String.color(ansiColor: String): String = ansiColor + this + RESET
//    fun String.green(): String = GREEN + this + RESET
//    fun String.red(): String = RED + this + RESET
//    fun String.blue(): String = BLUE + this + RESET
//    fun String.yellow(): String = YELLOW + this + RESET
//    fun String.cyan(): String = CYAN + this + RESET
//    fun String.white(): String = WHITE + this + RESET
//    fun String.black(): String = BLACK + this + RESET
//    fun String.purple(): String = PURPLE + this + RESET
//
//    // Reset
